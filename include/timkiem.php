    ...
    .bg {background: #000 !important;}
          ...
          <?php
           if(isset($_POST['search_button'])){
            ...
            $sql_product= mysqli_query($mysqli, "SELECT * FROM  sanpham where sanpham.tensanpham like '%$tukhoa%' order by sanpham.sanpham_id ASC");   //lấy danh mục từ csdl                                                 
            $title = $tukhoa;
        }
          ?> 
...
<style>
    h3{margin-left: 50%;font-size: 50px;}
