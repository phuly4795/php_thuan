...
<?php
    if(isset($_POST['dangnhap'])){
        ...
        if($taikhoan=='' || $matkhau==''){
            echo '<p  style="color: #fff;">không được bỏ trống</p>';
        }
        else{
            ...
            if($count>0){
                ...
                echo '<p style="color: #fff;">tài khoản hoặc mật khẩu sai</p>';
            }
        }
    }
?>
...
<div class="container">
    <div class="card card-login mx-auto text-center bg-dark">
        <div class="card-header mx-auto bg-dark">
                <span class="logo_title mt-5">LOGIN ADMIN</span>
        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="form-group">
                    <input type="submit" name="dangnhap" value="Login" class="btn btn-outline-danger float-right login_btn">
                </div>  
